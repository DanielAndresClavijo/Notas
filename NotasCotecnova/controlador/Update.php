...
//Estudiantes
if( !empty($_POST['estado_civil1']) && !empty($_POST['ciudad1']) && !empty($_POST['programa1']) && !empty($_POST['documento1']) && !empty($_POST['nombre1']) && !empty($_POST['apellido1']) && !empty($_POST['contrasenna1'])){
    ...
    $in = $mysql->EditarRegistros("UPDATE notas.estudiantes SET notas.estudiantes.documento_de_identificacion =".$documento1.",notas.estudiantes.nombres='".$nombre1."',notas.estudiantes.apellidos='".$apellido1."',notas.estudiantes.contrasenna='".$pass1."',notas.estudiantes.ciudades_id_ciudad_nacimiento=".$ciudad1.",notas.estudiantes.Programas_id_Programas=".$programa1.",notas.estudiantes.estado_civil_id_estado_civil=".$estado_civil1." where ".$enviar1." = notas.estudiantes.documento_de_identificacion");
