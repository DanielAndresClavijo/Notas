...
$asunto = "Correo informativo - Notas Cotecnova";

$carta = '<table style="max-width: 600px; padding: 10px; margin:0 auto; border-collapse: collapse;">
    <tr>
...
// Enviando Mensaje
echo mail($destinatario, $asunto, $carta);
