...
CREATE TABLE `ciudades` (
  `id_ciudad_nacimiento` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ciudad_nacimiento` varchar(45) DEFAULT NULL,
  `estado` int(5) NOT NULL,
  `departamentos_id_departamento_nacimiento` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id_ciudad_nacimiento`),
  UNIQUE KEY `id_ciudad_nacimiento_UNIQUE` (`id_ciudad_nacimiento`),
  KEY `fk_ciudades_departamentos1_idx` (`departamentos_id_departamento_nacimiento`),
  CONSTRAINT `fk_ciudades_departamentos1` FOREIGN KEY (`departamentos_id_departamento_nacimiento`) REFERENCES `departamentos` (`id_departamento_nacimiento`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1101 DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara las ciudades de los estudiantes y docentes';

INSERT INTO `ciudades` VALUES (1,"Abriaquí",1,5),
(2,"Acacías",1,50),
(3,"Acandí",1,27),
(4,"Acevedo",1,41),
(5,"Achí",1,13),
...
(999,"Tolú Viejo",1,70),
(1000,"Tona",1,68);
INSERT INTO `ciudades` VALUES (1001,"Topagá",1,15),
(1002,"Topaipí",1,25),
(1003,"Toribío",1,19),
(1004,"Toro",1,76),
(1005,"Tota",1,15),
...
CREATE TABLE `departamentos` (
  `id_departamento_nacimiento` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `departamento_nacimiento` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_departamento_nacimiento`),
  UNIQUE KEY `id_departamento_nacimiento_UNIQUE` (`id_departamento_nacimiento`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara los departamentos de los estudiantes y docentes';
...
CREATE TABLE `docentes` (
  ...
  `numero_de_identificacion` int(10) DEFAULT NULL,
  ...
  KEY `fk_docentes_ciudades1_idx` (`ciudades_id_ciudad_nacimiento`),
  KEY `fk_docentes_tipo_documento1_idx` (`tipo_documento_id_tipo_documento`),
  KEY `fk_docentes_estado_civil1_idx` (`estado_civil_id_estado_civil`),
  CONSTRAINT `fk_docentes_ciudades1` FOREIGN KEY (`ciudades_id_ciudad_nacimiento`) REFERENCES `ciudades` (`id_ciudad_nacimiento`) ON UPDATE CASCADE,
  CONSTRAINT `fk_docentes_estado_civil1` FOREIGN KEY (`estado_civil_id_estado_civil`) REFERENCES `estado_civil` (`id_estado_civil`) ON UPDATE CASCADE,
  CONSTRAINT `fk_docentes_tipo_documento1` FOREIGN KEY (`tipo_documento_id_tipo_documento`) REFERENCES `tipo_documento` (`id_tipo_documento`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='Tabla para guardar la informacion de los docentes';

INSERT INTO `docentes` VALUES (1,11111,"Administrador","Admin","bf86c75b92752bfb1439b3a5233500ce",0,1,1,1),
(2,43521,"daniel andres","clavijo","81dc9bdb52d04dc20036dbd8313ed055",1,1,1,1),
(3,1234567898,"daniel andres","giraldo","caf1a3dfb505ffed0d024130f58c5cfa",1,16,1,2),
(4,15464,"andres","giraldo","9bd5ee6fe55aaeb673025dbcb8f939c1",0,16,1,2),
(5,12344,"ferbab","derek","d93591bdf7860e1e4ee2fca799911215",0,15,1,2),
(6,12,"Lucio","Barraquil","c33367701511b4f6020ec61ded352059",0,14,1,2),
(7,43,"Edward","poles","81dc9bdb52d04dc20036dbd8313ed055",0,12,1,1),
(8,1234567898,"ferney","fernando","640a443672e27069a68471d5b3b5bd63",1,13,1,2),
(9,6573223,"Gerard","Butller","81dc9bdb52d04dc20036dbd8313ed055",0,82,1,1),
(10,22222,"Artulio","Fonseca","0aae0fede9a4d278e2f9a171e62fc76b",1,17,4,2),
(11,123,"Fernando","Alvarez","452e59f6084d94442fd8f653932afcb8",0,15,1,2),
(12,543217,"Federico Carlos","Hernandez de la Cruz","81dc9bdb52d04dc20036dbd8313ed055",0,14,1,1),
(13,1000000,"dao","giraldo","9cd013fe250ebffc853b386569ab18c0",0,16,1,2),
(14,10000002,1234,"giraldo","962012d09b8170d912f0669f6d7d9d07",0,15,2,2);


DROP TABLE IF EXISTS `estado_civil`;

CREATE TABLE `estado_civil` (
  `id_estado_civil` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `estado_civil` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_estado_civil`),
  UNIQUE KEY `id_estado_civil_UNIQUE` (`id_estado_civil`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara el estado civil de los estudiantes y docentes';
...
CREATE TABLE `estudiantes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `documento_de_identificacion` int(10) DEFAULT NULL,
  `nombres` varchar(45) DEFAULT NULL,
  `apellidos` varchar(45) DEFAULT NULL,
  `contrasenna` varchar(100) DEFAULT NULL,
  `estado_estudiantes` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_estudiantes_Programas1_idx` (`Programas_id_Programas`),
  KEY `fk_estudiantes_tipo_documento1_idx` (`tipo_documento_id_tipo_documento`),
  KEY `fk_estudiantes_estado_civil1_idx` (`estado_civil_id_estado_civil`),
  KEY `fk_estudiantes_ciudades1_idx` (`ciudades_id_ciudad_nacimiento`),
  CONSTRAINT `fk_estudiantes_Programas1` FOREIGN KEY (`Programas_id_Programas`) REFERENCES `programas` (`id_Programas`) ON UPDATE CASCADE,
  CONSTRAINT `fk_estudiantes_ciudades1` FOREIGN KEY (`ciudades_id_ciudad_nacimiento`) REFERENCES `ciudades` (`id_ciudad_nacimiento`) ON UPDATE CASCADE,
  CONSTRAINT `fk_estudiantes_estado_civil1` FOREIGN KEY (`estado_civil_id_estado_civil`) REFERENCES `estado_civil` (`id_estado_civil`) ON UPDATE CASCADE,
  CONSTRAINT `fk_estudiantes_tipo_documento1` FOREIGN KEY (`tipo_documento_id_tipo_documento`) REFERENCES `tipo_documento` (`id_tipo_documento`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Tabla para guardar informacion de los estudiantesv';

INSERT INTO `estudiantes` VALUES (1,1007374964,"sletsen","duque","81dc9bdb52d04dc20036dbd8313ed055",0,2,1,1,657),
(2,1004753326,"Juan Sebastian","Bayer","202cb962ac59075b964b07152d234b70",0,2,1,1,657);
...
CREATE TABLE `notas` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_notas_estudiantes1_idx` (`estudiantes_id`),
  KEY `fk_notas_docentes1_idx` (`docentes_id`),
  CONSTRAINT `fk_notas_docentes1` FOREIGN KEY (`docentes_id`) REFERENCES `docentes` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_notas_estudiantes1` FOREIGN KEY (`estudiantes_id`) REFERENCES `estudiantes` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Tabla para guardar informacion de las notas';

INSERT INTO `notas` VALUES (1,"2019-10-02 10:09:00",3,3,3,3,0,1,1),
...
INSERT INTO `programas` VALUES (1,"Gestión Contable"),
(2,"Ingeniería de sistemas"),
(3,"Administración de empresas"),
(4,"Mercadeo y ventas"),
(5,"Tecnología en sistemas de información"),
(6,"Administrador Agroindustrial"),
(7,"Administración de servicios de salud"),
(8,"Tecnología en regencia de farmacia"),
(9,"Licenciatura en pedagogía infantil"),
(10,"Licenciatura en inglés");
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara el tipo de documento de identidad de los estudiantes y docentes';
