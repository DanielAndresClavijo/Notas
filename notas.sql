...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2019 a las 21:48:32
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara las ciudades de los estudiantes y docentes';

--
-- Volcado de datos para la tabla `ciudades`
--

INSERT INTO `ciudades` (`id_ciudad_nacimiento`, `ciudad_nacimiento`, `estado`, `departamentos_id_departamento_nacimiento`) VALUES
(1, 'Abriaquí', 1, 5),
(2, 'Acacías', 1, 50),
(3, 'Acandí', 1, 27),
(4, 'Acevedo', 1, 41),
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara los departamentos de los estudiantes y docentes';

--
-- Volcado de datos para la tabla `departamentos`
--

INSERT INTO `departamentos` (`id_departamento_nacimiento`, `departamento_nacimiento`) VALUES
(5, 'ANTIOQUIA'),
(8, 'ATLÁNTICO'),
(11, 'BOGOTÁ, D.C.'),
(13, 'BOLÍVAR'),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabla para guardar la informacion de los docentes';
...
(1, 11111, 'Administrador', 'Admin', 'bf86c75b92752bfb1439b3a5233500ce', 0, 1, 1, 1),
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara el estado civil de los estudiantes y docentes';
...
CREATE TABLE `estudiantes` (
  ...
  `estado_civil_id_estado_civil` int(10) UNSIGNED NOT NULL,
  `ciudades_id_ciudad_nacimiento` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Tabla para guardar informacion de los estudiantesv';
...
(1, 1007374964, 'sletsen', 'duque', '81dc9bdb52d04dc20036dbd8313ed055', 0, 2, 1, 1, 657),
...
(1, '2019-10-02 10:09:00', 3, 3, 3, 3, 0, 1, 1),
...
INSERT INTO `programas` (`id_Programas`, `Programa_nombre`) VALUES
(1, 'Gestión Contable'),
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='En esta tabla se guardara el tipo de documento de identidad de los estudiantes y docentes';
...
ALTER TABLE `ciudades`
  ADD PRIMARY KEY (`id_ciudad_nacimiento`),
  ADD UNIQUE KEY `id_ciudad_nacimiento_UNIQUE` (`id_ciudad_nacimiento`),
  ADD KEY `fk_ciudades_departamentos1_idx` (`departamentos_id_departamento_nacimiento`);

--
-- Indices de la tabla `departamentos`
--
ALTER TABLE `departamentos`
  ADD PRIMARY KEY (`id_departamento_nacimiento`),
  ADD UNIQUE KEY `id_departamento_nacimiento_UNIQUE` (`id_departamento_nacimiento`);
...
ALTER TABLE `docentes`
  ...
  ADD KEY `fk_docentes_ciudades1_idx` (`ciudades_id_ciudad_nacimiento`),
  ADD KEY `fk_docentes_tipo_documento1_idx` (`tipo_documento_id_tipo_documento`),
  ADD KEY `fk_docentes_estado_civil1_idx` (`estado_civil_id_estado_civil`);
...
ALTER TABLE `estudiantes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_UNIQUE` (`id`),
  ADD KEY `fk_estudiantes_Programas1_idx` (`Programas_id_Programas`),
  ADD KEY `fk_estudiantes_tipo_documento1_idx` (`tipo_documento_id_tipo_documento`),
  ADD KEY `fk_estudiantes_estado_civil1_idx` (`estado_civil_id_estado_civil`),
  ADD KEY `fk_estudiantes_ciudades1_idx` (`ciudades_id_ciudad_nacimiento`);
...
ALTER TABLE `notas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_UNIQUE` (`id`),
  ADD KEY `fk_notas_estudiantes1_idx` (`estudiantes_id`),
  ADD KEY `fk_notas_docentes1_idx` (`docentes_id`);
...
ALTER TABLE `tipo_documento`
  ...
  ADD UNIQUE KEY `id_tipo_documento_UNIQUE` (`id_tipo_documento`);
...
--
ALTER TABLE `ciudades`
  ADD CONSTRAINT `fk_ciudades_departamentos1` FOREIGN KEY (`departamentos_id_departamento_nacimiento`) REFERENCES `departamentos` (`id_departamento_nacimiento`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `docentes`
--
ALTER TABLE `docentes`
  ADD CONSTRAINT `fk_docentes_ciudades1` FOREIGN KEY (`ciudades_id_ciudad_nacimiento`) REFERENCES `ciudades` (`id_ciudad_nacimiento`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_docentes_estado_civil1` FOREIGN KEY (`estado_civil_id_estado_civil`) REFERENCES `estado_civil` (`id_estado_civil`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_docentes_tipo_documento1` FOREIGN KEY (`tipo_documento_id_tipo_documento`) REFERENCES `tipo_documento` (`id_tipo_documento`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `estudiantes`
--
ALTER TABLE `estudiantes`
  ADD CONSTRAINT `fk_estudiantes_Programas1` FOREIGN KEY (`Programas_id_Programas`) REFERENCES `programas` (`id_Programas`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiantes_ciudades1` FOREIGN KEY (`ciudades_id_ciudad_nacimiento`) REFERENCES `ciudades` (`id_ciudad_nacimiento`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiantes_estado_civil1` FOREIGN KEY (`estado_civil_id_estado_civil`) REFERENCES `estado_civil` (`id_estado_civil`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiantes_tipo_documento1` FOREIGN KEY (`tipo_documento_id_tipo_documento`) REFERENCES `tipo_documento` (`id_tipo_documento`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `notas`
--
ALTER TABLE `notas`
  ADD CONSTRAINT `fk_notas_docentes1` FOREIGN KEY (`docentes_id`) REFERENCES `docentes` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_notas_estudiantes1` FOREIGN KEY (`estudiantes_id`) REFERENCES `estudiantes` (`id`) ON UPDATE CASCADE;
COMMIT;
